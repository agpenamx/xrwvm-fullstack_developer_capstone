# Import models for CarMake and CarModel
from .models import CarMake, CarModel

def initiate():
    """
    Populates the database with predefined car makes and car models
    when the `get_cars` function is called for the first time.
    """
    car_make_data = [
